...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>	
  ...
  <!-- daterange picker -->
  <link rel="stylesheet" href="${midasLocation}/bower_components/bootstrap-daterangepicker/daterangepicker.css">
  <!-- bootstrap datepicker -->
  <link rel="stylesheet" href="${midasLocation}/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- iCheck for checkboxes and radio inputs -->
  <link rel="stylesheet" href="${midasLocation}/plugins/iCheck/all.css">
  <!-- Bootstrap Color Picker -->
  <link rel="stylesheet" href="${midasLocation}/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
  <!-- Bootstrap time Picker -->
  <link rel="stylesheet" href="${midasLocation}/plugins/timepicker/bootstrap-timepicker.min.css">
	  ...
	  <link rel="shortcut icon" type="image/x-icon" href="/resources/img/arcanjo-tn.png"/>
	  ...
	  <link rel="stylesheet" href="${midasLocation}/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
	  
	  <link rel="stylesheet" href="${midasLocation}/sweetalert2.min.css">
	  
	  <!-- TREANT --> 
	  <link rel="stylesheet" href="/resources/treant/Treant.css" type="text/css"/>	  
