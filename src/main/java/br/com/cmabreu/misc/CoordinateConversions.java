...
public class CoordinateConversions
{
    ...
    public static double[] xyzToLatLonRadians(double[] xyz)
    {
        ...
        //System.out.println("X xyzToLatLonRadians " + answer[0]);
       // System.out.println("Y xyzToLatLonRadians " + answer[1]);
       // System.out.println("Z xyzToLatLonRadians " + answer[2]);
    ...
    //    System.out.println("  ");
     //   System.out.println("  ");
      //  System.out.println("  ");
     //   System.out.println("  ");
     //   System.out.println("X xyzToLatLonDegrees " + degrees[0]);
     //   System.out.println("Y xyzToLatLonDegrees " + degrees[1]);
      //  System.out.println("Y xyzToLatLonDegrees " + degrees[2]);
    ...
    public static double[] getXYZfromLatLonDegrees(double latitude, double longitude, double height)
    {
        double degrees[] = CoordinateConversions.getXYZfromLatLonRadians(latitude * CoordinateConversions.DEGREES_TO_RADIANS, 
                                                                   ...
                                                                   height);
       // System.out.println("getXYZfromLatLonDegrees 1 " + degrees[0]);
      //  System.out.println("getXYZfromLatLonDegrees 2 " + degrees[1]);
      //  System.out.println("getXYZfromLatLonDegrees 3 " + degrees[2]);
