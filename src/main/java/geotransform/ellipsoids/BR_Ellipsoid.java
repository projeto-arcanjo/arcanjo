 ...
 * 
 * Description: *//**
 *   Defines a Bessel 1841 (Ethiopia Indonesia Japan Korea) ellipsoid.
 *  
 ...
 *   b = a(1-f).
 *
 *   For the Bessel 1841 (Ethiopia Indonesia Japan Korea) ellipsoid,
 *   a   = 6377397.155,
 *   1/f = 299.1528128.
 *
 * @author Dan Toms, SRI International
 *
 * @version $Id: BR_Ellipsoid.java,v 1.1.1.1 2000/06/15 16:49:27 reddy Exp $
 *
 * @since 1.0
 *
 * @see Ellipsoid
