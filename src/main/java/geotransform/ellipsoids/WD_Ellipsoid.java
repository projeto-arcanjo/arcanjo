 ...
 *   b = a(1-f).
 *
 *   For the WGS 72 ellipsoid,
 *   a   = 6378135,
 *   1/f = 298.26.
 *
 * @author Dan Toms, SRI International
 *
 * @version $Id: WD_Ellipsoid.java,v 1.1.1.1 2000/06/15 16:49:27 reddy Exp $
 *
 * @since 1.0
 *
 * @see Ellipsoid
