 ...
 *
 * Description: *//**
 *   Represents a OSGB coordinate.
 *
 *   This class is used to represent a single point in the Ordenance
 *   Survey Great Britain projection. This is represented with an
 ...
 * @Author: Jesus Diaz Centeno, Batmap S.A. <URL:mailto:jesus.diaz@batmap.com>
 *
 * @version $Id: OSGB_Coord_3d.java,v 1.2 2002/01/24 06:32:11 reddy Exp $
 *
 * @see Gcc_Coord_3d
 * @see Gdc_Coord_3d
 *
...
public class OSGB_Coord_3d {
  ...
  /*
   * Method: OSGB_Coord_3d::OSGB_Coord_3d
   *
   * Description: *//**
   *   Constructor for OSGB_Coord_3d.
   *
   ...
   *
   * @param X      the OSGB easting coordinate (meters)
   * @param Y      the OSGB northing coordinate (meters)
   * @param Z      the OSGB elevation value (meters)
   * @param hemi_n true if the OSGB coordinate is in the northern hemisphere
   *
   * @since  1.0
   *
   */

  public OSGB_Coord_3d(double X, double Y, double Z, boolean hemi_n)
  {
    x = X;
    y = Y;
    z = Z;
