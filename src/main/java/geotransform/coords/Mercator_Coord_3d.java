//
// Filename: Mercator_Coord_3d.java
//
...
/*
 * Class: Mercator_Coord_3d
 *
 * Description: *//**
 *   Represents a Mercator coordinate.
 *
 ...
 * @Author: Jesus Diaz Centeno, Batmap S.A. <URL:mailto:jesus.diaz@batmap.com>
 *
 * @version $Id: Mercator_Coord_3d.java,v 1.1 2002/01/24 06:32:11 reddy Exp $
 *
 * @see Gcc_Coord_3d
 * @see Gdc_Coord_3d
 *
...
public class Mercator_Coord_3d {
  ...
  /*
   * Method: Mercator_Coord_3d::Mercator_Coord_3d
   *
   * Description: *//**
   *   Constructor for Mercator_Coord_3d.
   *
   *   This constructor will create a new instance of the Mercator_Coord_3d
   ...
   *
   * @param X      the Mercator easting coordinate (meters)
   * @param Y      the Mercator northing coordinate (meters)
   * @param Z      the Mercator elevation value (meters)
   * @param hemi_n true if the Mercator coordinate is in the northern hemisphere
   *
   * @since  1.0
   *
   */

  public Mercator_Coord_3d(double X, double Y, double Z, boolean hemi_n){
    x = X;
    y = Y;
    z = Z;
